...
STRATEGY_DESCRIPTIONS = {
    ...
    "maps_heavy": "Maps focused. Heavy maps_browse weighting from week 1.",
...
ACTIVITY_CHOICES = [
    ...
    "maps_browse", "calendar_setup", "calendar_browse",
...
def load_accounts(pc_filter: str = "") -> list[dict]:
    ...
    if not accounts:
        print(f"\n  No accounts found at {CONFIG_FILE}\n")
        sys.exit(1)
    if pc_filter:
