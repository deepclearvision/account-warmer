...
Copy-Item -Path "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\test_rpa_with_adb.py" `
          -Destination "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\account-warmer\test_rpa_with_adb.py" `
          -ToSession $s

Write-Host "=== Testing RPA element interaction with ADB-opened Settings ==="
Invoke-Command -Session $s -ScriptBlock {
    cd "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\account-warmer"
    python test_rpa_with_adb.py 2>&1
} -ErrorAction Continue

Write-Host ""
Write-Host "=== Copying screenshots ==="
$localDir = "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\rpa_adb_screenshots"
New-Item -ItemType Directory -Force -Path $localDir | Out-Null
$files = Invoke-Command -Session $s -ScriptBlock {
    Get-ChildItem "C:\WarmingData\screenshots\rpa_adb_test\*.png" -ErrorAction SilentlyContinue |
