...
Write-Host "Copying check script..."
Copy-Item -Path "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\vps_check.py" `
          -Destination "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\" `
          -ToSession $s -Force
