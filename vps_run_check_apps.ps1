...
# Copy the python script to VPS
Copy-Item -Path "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\check_apps_script.py" `
          -Destination "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\account-warmer\check_apps_script.py" `
          -ToSession $s

Invoke-Command -Session $s -ScriptBlock {
    cd "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\account-warmer"
    python check_apps_script.py 2>&1
}
