...
Copy-Item -Path "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\test_totp_debug.py" `
          -Destination "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\account-warmer\test_totp_debug.py" `
          -ToSession $s

Invoke-Command -Session $s -ScriptBlock {
    cd "C:\Users\Administrator\Desktop\AccountWarmer-Deploy\account-warmer"
    python test_totp_debug.py 2>&1
...
$files = Invoke-Command -Session $s -ScriptBlock {
    Get-ChildItem "C:\WarmingData\screenshots\totp_debug\*" -ErrorAction SilentlyContinue |
