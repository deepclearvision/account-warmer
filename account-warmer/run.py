...
if __name__ == "__main__":
    ...
    parser.add_argument("--activity",type=str,            choices=["search","email_read","email_send","browse","newsletter_signup","maps_browse","maps_review","calendar_setup","calendar_browse","calendar_add","drive_setup","drive_browse","drive_edit","drive_create","business_signal"],
